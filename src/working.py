...
if __name__ == "__main__":
    ...
    ax1 = sns.heatmap(correlation_matrix, mask=mask_upper, cmap='coolwarm',
                      linewidths=.5, annot=True, fmt=".2f",
                      annot_kws={"fontsize": 16}, xticklabels=False,
                      yticklabels=False)
    ax2 = sns.heatmap(correlation_matrix, mask=mask_lower, cmap='coolwarm',
                      linewidths=.5, annot=True, fmt=".2f",
    ...
    ax2.set_title("Beer Ratings Correlation Matrix", fontsize=20, fontweight='bold')
